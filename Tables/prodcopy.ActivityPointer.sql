...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgActivityPointer_CopyLoadDate] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [idx_activityid] ON [prodcopy].[ActivityPointer] ([activityid])
GO

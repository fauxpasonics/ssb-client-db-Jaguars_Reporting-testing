...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgAccount_CopyLoadDate] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Account] ADD CONSTRAINT [PK__Account__F20699F624858A40] PRIMARY KEY CLUSTERED  ([accountid])
GO

...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgOpportunity_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Opportunity] ADD CONSTRAINT [PK__Opportun__736BF79C190AF5E9] PRIMARY KEY CLUSTERED  ([opportunityid])
GO

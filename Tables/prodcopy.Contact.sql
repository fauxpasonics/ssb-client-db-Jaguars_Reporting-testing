...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_Contact_CopyLoadDate] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [idx_accountid] ON [prodcopy].[Contact] ([accountid])
GO
CREATE NONCLUSTERED INDEX [idx_prodcopy_Contact_contactid] ON [prodcopy].[Contact] ([contactid]) INCLUDE ([accountid])
GO

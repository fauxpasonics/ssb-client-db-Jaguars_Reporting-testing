...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgPhoneCall_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[PhoneCall] ADD CONSTRAINT [PK__PhoneCal__0FC8C7C44366FF90] PRIMARY KEY CLUSTERED  ([activityid])
GO

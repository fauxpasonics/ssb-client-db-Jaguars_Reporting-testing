...
[regardingobjectidname] [nvarchar] (300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[regardingobjectidyominame] [nvarchar] (300) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[str_clientphonecallresult] [int] NULL,
[str_clientphonecallresultname] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_PhoneCall_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[PhoneCall] ADD CONSTRAINT [PK__PhoneCal__0FC8C7C463D4EC0F] PRIMARY KEY CLUSTERED  ([activityid])
GO
CREATE NONCLUSTERED INDEX [idx_activityid] ON [prodcopy].[PhoneCall] ([activityid])
GO

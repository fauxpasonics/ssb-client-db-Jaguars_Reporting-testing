...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgListMember_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[ListMember] ADD CONSTRAINT [PK__ListMemb__2A050A0E102351CC] PRIMARY KEY CLUSTERED  ([listmemberid])
GO

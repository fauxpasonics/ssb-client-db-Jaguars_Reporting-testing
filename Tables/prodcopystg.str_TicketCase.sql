...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgTicketCase_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[str_TicketCase] ADD CONSTRAINT [PK__str_Tick__0D16568266FC2818] PRIMARY KEY CLUSTERED  ([str_ticketcaseid])
GO

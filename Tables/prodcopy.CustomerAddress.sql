...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_CustomerAddress_CopyLoadDate] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [idx_customeraddressid] ON [prodcopy].[CustomerAddress] ([customeraddressid])
GO

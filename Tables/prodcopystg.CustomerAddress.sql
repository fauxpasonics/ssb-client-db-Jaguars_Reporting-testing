...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_stgCustomerAddress_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[CustomerAddress] ADD CONSTRAINT [PK__Customer__B4F003156D1C0C37] PRIMARY KEY CLUSTERED  ([customeraddressid])
GO

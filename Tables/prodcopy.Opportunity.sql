...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_Opportunity_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Opportunity] ADD CONSTRAINT [PK__Opportun__736BF79C0D725BAD] PRIMARY KEY CLUSTERED  ([opportunityid])
GO

...
[CopyLoadDate] [datetime] NOT NULL CONSTRAINT [const_Lead_CopyLoadDate] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Lead] ADD CONSTRAINT [PK__Lead__2870F16BA76C3466] PRIMARY KEY CLUSTERED  ([leadid])
GO
CREATE NONCLUSTERED INDEX [idx_accountid] ON [prodcopy].[Lead] ([accountid])
GO
